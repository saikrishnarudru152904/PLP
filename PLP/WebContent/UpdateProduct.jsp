...
<body>
	...
	<form action="action_page.php">
		<table>
			...
			<tr>
				...
				<option value="">Choose Discount</option>
						...
						<option value="Flat25">Flat25</option>
						<option value="Upto50">Upto50</option>
						<option value="Get15">Get15</option>
						<option value="Upto25">Upto25</option>

				</select></td>
			</tr>
			<tr>
				<td><b>Add PromoCode: </b></td>
				<td><select name="promrocodes">
				<option value="">Choose PromoCode</option>
						<option value="FIRST25">FIRST25</option>
						<option value="FP50">FP50</option>
						<option value="LOT15">LOT15</option>
			...
			<tr>
				...
				<td><input type="image" name="pImage" required /> <img
		...
		<br>
		<button type="submit" onclick="alertName()">Update</button>
		&nbsp; &nbsp; &nbsp;
		<script type="text/javascript">
					function alertName() {
